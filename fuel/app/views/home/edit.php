  ...
  <div class="container" id="container">
    <div class="hero-unit">
      <div class="container-fluid"><div class="row-fluid">
        ...
        <h2><span id="editingLang" class="audiowide"></span><span>&nbsp;&nbsp;編集中</span></h2>
          ...
          <fieldset>
            <div class="control-group input pull-right span5">
              ...
              <div class="controls docs-input-sizes">
                <input required type="text" data-input="title" maxlength="30" class="span12" placeholder="タイトル(必須)" value="<?php echo $code_data['title'] ?>">
              </div>
              <div class="controls docs-input-sizes">
                <textarea data-input="description" maxlength="200" class="span12" rows="3" placeholder="説明文(任意)"><?php echo $code_data['description'] ?></textarea>
              </div>
            </div>
    ...
    <div id="editor" class="flat" style="opacity:0"><pre><?php echo $code_data['code'] ?></pre></div>

    <div class="hidden" id="code-data"><?php echo $code_data['code_id'].'/'.$code_data['editor_theme'].'/'.$code_data['font_size'].'/'.$code_data['tip_color'].'/'.$code_data['open']; ?></div>
